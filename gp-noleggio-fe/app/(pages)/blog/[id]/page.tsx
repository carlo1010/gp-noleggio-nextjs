...
export default async function Page({ params }: BlogPageProps) {
    ...
    // Estraiamo l'immagine dell'anteprima per usarla come immagine principale dell'articolo
    ...
    return (
        <main className="bg-white min-h-screen">
            ...
            {/* Hero fissa del blog */}
            <HeroBanner
                imageUrl="/hero/sfondo-hero-blog.jpg"
                showSearch={true}
            />
                ...
                <div className="container mx-auto px-4 max-w-[1240px]">
                    ...
                    <div className="mb-10">
                        <NextBreadcrumb
                            ...
                            containerClasses='flex text-sm font-semibold'
                    ...
                    <header className="text-center max-w-4xl mx-auto mb-14">
                        <p className="text-sm font-bold tracking-[0.2em] text-gray-400 uppercase mb-4">
                            {post.kicker}
                        </p>
