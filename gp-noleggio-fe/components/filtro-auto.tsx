                        ...
                        <Dialog>
                            <DialogTrigger asChild>
                                <Button variant="outline" className="gap-2">
                                    <RotateCw className="h-4 w-4" /> Filtri
                                </Button>
                            </DialogTrigger>
                            ...
                            <DialogContent className="w-[90%] rounded-lg max-h-[80vh] overflow-y-auto">
                                ...
                                <div className="flex flex-col gap-4">
                                    ...
                                    {/* Posti */}
                                    <div className="space-y-2">
                                        <span className="text-sm font-semibold">Posti</span>
                                    ...
                                    {/* Tipologia */}
                                    <div className="space-y-2">
                                        <span className="text-sm font-semibold">Tipologia</span>
                                    ...
                                    {/* Prezzo */}
                                    <div className="space-y-2">
                                        <span className="text-sm font-semibold">Prezzo</span>
                                    ...
                                    <div className="pt-4">
                                        <Button className="w-full bg-[#0700DE]" onClick={() => document.getElementById("close-dialog")?.click()}>
                                            Vedi risultati
                                        </Button>
                                    </div>
                                </div>
