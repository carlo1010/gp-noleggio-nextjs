...
import { Building, Car, Info, MapPin, Truck, User, CalendarArrowUp, CalendarArrowDown,ClockArrowUp,ClockArrowDown } from "lucide-react";
        ...
        >
            ...
            <div className="grid grid-cols-4 gap-x-3 gap-y-6">
                ...
                <div className="flex col-span-1 flex-col gap-2">
                    ...
                    >
                        {/* Option: Privato */}
                        <div className={`transition-colors border-r ${customerType === "private" ? "bg-[#0700DE]" : "bg-white hover:bg-gray-50"}`}>
                        ...
                        {/* Option: Azienda */}
                        <div className={`transition-colors ${customerType === "business" ? "bg-[#0700DE]" : "bg-white hover:bg-gray-50"}`}>
                ...
                <div className="flex col-span-1 flex-col gap-2">
                    ...
                    >
                        {/* Option: Auto */}
                        <div className={`transition-colors border-r ${vehicleType === "car" ? "bg-[#0700DE]" : "bg-white hover:bg-gray-50"}`}>
                        ...
                        {/* Option: Furgoni */}
                        <div className={`transition-colors ${vehicleType === "van" ? "bg-[#0700DE]" : "bg-white hover:bg-gray-50"}`}>
                ...
                <div className="col-span-1 space-y-2">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            />
                            <Label className='text-xs cursor-pointer' htmlFor="same-office">Riconsegna nello stesso ufficio</Label>
                        </div>
                    </div>
                        ...
                        <div className="w-1/2 border-r border-gray-300">
                            ...
                            {pickupDate ? pickupDate.toLocaleDateString() : tomorrow.toLocaleDateString()}
                                ...
                                <PopoverContent className="w-auto p-0" align="start">
                                    <Calendar mode="single" selected={pickupDate} onSelect={(d) => {setPickupDate(d); setPickupOpen(false)}} />
                                </PopoverContent>
                            </Popover>
                        </div>

                        {/* RIGHT SIDE: TIME SELECT */}
                        <div className="w-1/2 flex items-center justify-center bg-white hover:bg-gray-50 transition-colors relative">
                        ...
                        <div className="flex h-11 rounded-tl-sm rounded-br-sm border border-gray-300 overflow-hidden">
                            ...
                            <div className="w-1/2 border-r border-gray-300">
                                ...
                                {dropoffDate ? dropoffDate.toLocaleDateString() : dayAfterTomorrow.toLocaleDateString()}
                                    ...
                                    <PopoverContent className="w-auto p-0" align="start">
                                        <Calendar mode="single" selected={dropoffDate} onSelect={(d) => {setDropoffDate(d); setDropoffOpen(false)}} />
                                    </PopoverContent>
                                </Popover>
                            </div>
            ...
            <div className="grid grid-cols-4 pt-4 items-center gap-y-4">
                ...
                <div className="flex justify-start gap-x-12 flex-row col-span-3">
                    ...
                    <div className="flex items-center">
                        <label className="flex items-center gap-1 text-sm text-gray-800 cursor-pointer">
                            <span>Età</span>
                            <select className="bg-transparent border-none outline-none font-semibold pr-4 cursor-pointer" defaultValue="26+">
                    ...
                    <div className="flex items-center">
                        <label className="flex items-center gap-1 text-sm text-gray-800 cursor-pointer">
                            <span>Vivo in</span>
                            <select className="bg-transparent border-none outline-none font-semibold pr-4 cursor-pointer" defaultValue="IT">
                        ...
                        {hasPromo && (
                            <div className="animate-in fade-in zoom-in-95 duration-200">
                                <input
                                    ...
                                    className="h-9 w-32 rounded-sm border border-gray-300 px-3 text-sm focus:ring-1 focus:ring-[#0700DE] outline-none"
                                />
                            </div>
                        )}
                    </div>
                ...
                */}
                <div className="col-span-1">
                    <Button className="w-full h-12 bg-[#0700DE] hover:bg-[#0500b0] rounded-tl-sm rounded-br-sm text-lg font-bold transition-all">
                        Cerca
                    </Button>
                </div>
            </div>
