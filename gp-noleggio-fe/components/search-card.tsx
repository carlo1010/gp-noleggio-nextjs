                ...
                <div className="col-span-2 space-y-2">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            <Checkbox checked={stessoUfficioChecked}
                                      onCheckedChange={() => {
                                          setStessoUfficioChecked(!stessoUfficioChecked) // TODO: ciao
                                          // console.log(stessoUfficioChecked)
                                      }}
                                      id="terms"/>
                    ...
                    <div className="flex items-center gap-x-2 justify-between">
                        ...
                        <Select >
                            <SelectTrigger className="w-full rounded-bl-none rounded-br-sm rounded-tl-sm rounded-tr-none focus:ring-1 focus:ring-[#0700DE] focus:border-[#0700DE] border border-gray-300">
                                <SelectValue placeholder="Seleziona punto di ritiro"/>
                            </SelectTrigger>
                            <SelectContent >
                                <SelectGroup>
                                    {
                                    ...
                                    {agenzie && agenzie.map((agenzia) => (
                                        <SelectItem key={agenzia.codiceAgenzia} value={agenzia.codiceAgenzia}>{agenzia.descrizioneAgenzia} - {agenzia.localitaAgenzia}</SelectItem>
                                    ))}
                                </SelectGroup>
                            </SelectContent>
                        </Select>
                            ...
                            !stessoUfficioChecked && (
                                <Select >
                                    ...
                                    <SelectContent >
                                        <SelectGroup>
                                            {agenzie && agenzie.map((agenzia) => (
                                                <SelectItem key={agenzia.codiceAgenzia} value={agenzia.codiceAgenzia}>{agenzia.descrizioneAgenzia}</SelectItem>
                                            ))}
                                        </SelectGroup>
                                    </SelectContent>
                                </Select>
