...
export default function Footer() {
    ...
    return (
        <footer className="bg-[#F7F7F7] ">
            ...
            <div className="flex flex-col md:flex-row container mx-auto px-4 py-8 md:py-12 max-w-[1240px] gap-8 md:gap-0">

                <div className="flex justify-start flex-col w-full md:w-1/2 gap-y-2">
                ...
                <div className="w-full md:w-1/2">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-x-3 gap-y-8 md:gap-y-0">
