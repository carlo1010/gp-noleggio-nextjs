...
export default function HeroBanner({ imageUrl, title, description, promo }: HeroBannerProps) {
    ...
    return (
        <section className={`relative flex items-end pt-32 md:pt-0 ${hasContent
            ...
            <div className={`relative w-full z-30 container mx-auto px-4 max-w-[1240px] pb-16 ${hasContent ? "mt-16 md:mt-0" : "mt-8 md:mt-0"
                }`}>
                <SearchCard />
            </div>
        </section>
